 ...
 *
 */
public class SelectByCriteriaAction extends DataAccessAction {

	private String tablename;
	private String sql;

	public SelectByCriteriaAction(String tablename) {

		this.tablename = tablename;
		this.sql = String.format("SELECT * FROM %s WHERE ", tablename);
